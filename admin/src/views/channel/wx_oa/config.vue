        ...
        <el-form ref="formRef" :model="formData" :rules="formRules" :label-width="appStore.isMobile ? '80px' : '160px'">
            ...
            <el-card class="!border-none mt-4" shadow="never">
                ...
                <el-form-item label="EncodingAESKey" prop="encoding_aes_key">
                    <div class="flex-1 min-w-0">
                        <div class="w-80">
                            <el-input v-model="formData.encoding_aes_key" placeholder="请输入EncodingAESKey" />
                        </div>
                ...
                <el-form-item label="消息加密方式" required prop="encryption_type">
                    <div class="flex-1 min-w-0">
                        <el-radio-group class="flex-col !items-start min-w-0" v-model="formData.encryption_type">
                            <el-radio :label="1"> 明文模式 (不使用消息体加解密功能，安全系数较低) </el-radio>

                            <el-radio :label="2"> 兼容模式 (明文、密文将共存，方便开发者调试和维护) </el-radio>
                            <el-radio :label="3">
            ...
            <el-card class="!border-none mt-4" shadow="never">
                ...
                <el-form-item label="业务域名">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="form-tips">登录微信公众平台，点击设置>公众号设置>功能设置，填写业务域名</div>
                    </div>
                </el-form-item>
                <el-form-item label="JS接口安全域名">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="form-tips">登录微信公众平台，点击设置>公众号设置>功能设置，填写JS接口安全域名</div>
                    </div>
                </el-form-item>
                <el-form-item label="网页授权域名">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="form-tips">登录微信公众平台，点击设置>公众号设置>功能设置，填写网页授权域名</div>
                    </div>
                </el-form-item>
            </el-card>
        </el-form>
