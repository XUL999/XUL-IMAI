<template>
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div>
                <el-button
                    v-perms="['ai_application.sd.inspiration_category/add']"
                    type="primary"
                    @click="openPop('add')">
                    <template #icon>
            ...
            <el-table class="mt-4" v-loading="pager.loading" :data="pager.lists">
                <el-table-column label="分类名称" prop="title" min-width="120" />
                <el-table-column
                    label="状态"
                    min-width="100"
                    v-perms="['ai_application.sd.inspiration_category/status']">
                ...
                <el-table-column label="操作" width="150" fixed="right">
                    <template #default="{ row }">
                        <el-button
                            v-perms="['ai_application.sd.inspiration_category/edit']"
                            type="primary"
                            link
                        ...
                        <el-button
                            v-perms="['ai_application.sd.inspiration_category/delete']"
                            type="danger"
                            link
...
import { getModelCategoryList, delModelCategory, editModelCategoryStatus } from "@/api/ai_application/draw/draw_sd";
