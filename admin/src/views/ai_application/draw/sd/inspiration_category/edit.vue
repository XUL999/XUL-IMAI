...
import { addModelCategory, editModelCategory } from "@/api/ai_application/draw/draw_sd";
...
const handleSubmit = async () => {
    try {
        ...
        formData.value.id ? await editModelCategory(formData.value) : await addModelCategory(formData.value);
