        ...
        <popup ref="popupRef" :title="popupTitle" :async="true" width="550px" @confirm="handleSubmit">
            <el-form class="ls-form" ref="formRef" :rules="rules" :model="formData" label-width="90px">
                ...
                <el-form-item label="排序">
                    <div class="w-64">
                        <el-input class="" v-model="formData.sort" :min="0" :max="9999" />
...
import { addDrawCategory, editDrawCategory } from "@/api/ai_application/draw/draw_sd";
...
const handleSubmit = async () => {
    try {
        ...
        formData.value.id ? await editDrawCategory(formData.value) : await addDrawCategory(formData.value);
